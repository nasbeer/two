  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography component="h2" variant="h5" sx={{mb:1, fontSize:'1.2rem', textAlign:'center', color:'green'}}>
            {item.type}
            </Typography>
          <Image src={item.cover} width={760} height={760} alt={'Course ' + item.id} />
        </Box>
        <Box sx={{ mb: 2 }}>
          <Typography component="h2" variant="h5" sx={{ mb: 1, height: 26, overflow: 'hidden', fontSize: '1.2rem' }}>
            {item.title}
          </Typography>
          <Typography component="p">{item.category}</Typography>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h6">Ask for Price</Typography>
          </Box>
          <IconButton
            color="primary"
