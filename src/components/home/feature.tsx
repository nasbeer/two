        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              <Image src="/images/feature.png" width={650} height={628}  quality={97} alt="Feature img" />
              {/* <Box
                sx={{
                  position: 'absolute',
                  top: -36,
          ...
          <Grid item xs={12} md={7}>
            ...
            Jasmine Lane by Elie Saab is an elite residential complex by the development companies of Durar and Fortune 5. The project is distinguished by its exceptional design from the world-renowned fashion icon Elie Saab. As of May 2023, the project is under construction with the anticipated date of completion in June 2024.
            </Typography>
