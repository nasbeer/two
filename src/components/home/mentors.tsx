  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        <Typography sx={{ mb: 6, textAlign:'center', fontSize:30}}>The exceptional complex of Jasmine Lane by Elie Saab offers a wide range of premium amenities and services, presented by:</Typography>
